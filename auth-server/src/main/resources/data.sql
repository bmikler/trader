...
INSERT INTO oauth2client (id, auth_method, client_id, grant_type, redirect_uri, scope, secret) VALUES ('688d6e2c-b69f-4a30-83ef-8264b990cd28', 'client_secret_basic', 'gateway-client-id', 'authorization_code', 'http://localhost:8088/authorized', 'openid',  '$2a$05$ufo6HjX/Fr7JKB0viTLjHONnHMzt1VzifcqfDs5NdMjDFBkdfIWk.');
